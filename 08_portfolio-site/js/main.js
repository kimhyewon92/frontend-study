...
const aniSpans = document.querySelectorAll('.visual h1 span');
...
window.addEventListener('scroll', function () {
  ...
  if (window.scrollY > 500) {
    ...
    aniSpans.forEach(function (aniSpan) {
        aniSpan.classList.remove('animate-flash');
    });
    ...
    // visual 섹션 애니메이션 넣기
    aniSpans.forEach(function (aniSpan) {
      aniSpan.classList.add('animate-flash');
  });
  }
});
